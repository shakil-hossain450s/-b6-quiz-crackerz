    ...
    return (
        <div className='bg-white p-5 rounded-lg shadow-2xl relative'>
            <EyeIcon onClick={() => handleToSetCorrectAns(correctAnswer)}
                className='w-5 h-5 absolute top-2 right-5 cursor-pointer hover:text-green-600'></EyeIcon>
            <h2 className='text-xl font-medium mt-3'>Question : {removeTags(question)}</h2>
